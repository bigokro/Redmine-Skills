module SkillsHelper
  ...
  def skills_top_menu_tabs
    tabs = [{:name => 'skills', :controller => 'skills', :action => :index, :partial => 'skills/list', :label => :label_skills},
            {:name => 'users', :controller => 'user_skills', :action => :index, :partial => 'skills/users', :label => :label_user_plural},
            {:name => 'issues', :controller => 'skills_matcher', :action => :find_issues_for_user, :partial => 'skills/issues', :label => :label_issue_plural}
            ]
